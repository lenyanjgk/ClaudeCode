...
![image-20260303093940759](assets/image-20260303093940759.png)
...
![image-20260303094059462](assets/image-20260303094059462.png)

```
claude mcp remove filesystem -s user
```

![image-20260303094135986](assets/image-20260303094135986.png)

删除成功：![image-20260303094218308](assets/image-20260303094218308.png)
...
![image-20260303094322453](assets/image-20260303094322453.png)
...
![image-20260303092442716](assets/image-20260303092442716.png)
...
![image-20260303094903495](assets/image-20260303094903495.png)
...
>  ![image-20260309105503911](assets/image-20260309105503911.png)
...
>  ![image-20260309105529950](assets/image-20260309105529950.png)
...
>  ![image-20260309105555441](assets/image-20260309105555441.png)
...
> ![image-20260309105637688](assets/image-20260309105637688.png)

#### 第五步：等待 Claude 生成

Claude 会根据你的描述自动生成代理的名称、系统提示词、工具选择等配置：

> ![image-20260309105649445](assets/image-20260309105649445.png)
...
> ![image-20260309105659270](assets/image-20260309105659270.png) 
...
> ![image-20260309105726331](assets/image-20260309105726331.png)

#### 第八步：选择颜色标识

给代理设置一个背景色，方便在会话中一眼识别它的输出（比如代码审核用绿色、安全审计用红色）。

> ![image-20260309105738430](assets/image-20260309105738430.png) 
...
> ![image-20260309105810187](assets/image-20260309105810187.png) 
...
> ![image-20260309105823738](assets/image-20260309105823738.png)

![image-20260309105839854](assets/image-20260309105839854.png)
...
> ![image-20260309105848512](assets/image-20260309105848512.png)

审核完成后，代理会返回完整的审核报告，收工：

> ![image-20260309105902528](assets/image-20260309105902528.png)
