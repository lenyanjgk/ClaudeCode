...
| 章节 | 主题 | 你将学到 |
|------|------|---------|
| 第07章 | 从单兵到团队——企业级协作规范、CI/CD 与安全合规实战 | 团队协作规范、GitHub Actions CI/CD 集成、安全权限配置、成本控制，让 10 人团队高效安全用上 Claude Code |
| 第08章 | CLAUDE.md 与多模态完整指南 | 项目记忆文件深度配置、多模态处理（图片/截图/设计稿） |
| 第09章 | Claude Agent SDK 完整指南 | SubAgents 角色配置、工具权限划分、多 Agent 并行编排，让 AI 团队分工为你打工 |
